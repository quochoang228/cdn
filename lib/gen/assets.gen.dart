...
class $AssetsIconsGen {
  ...
  SvgGenImage get connection =>
      const SvgGenImage('assets/icons/connection.svg');
  ...
  /// File path: assets/icons/hard-hat 1.svg
  SvgGenImage get hardHat1 => const SvgGenImage('assets/icons/hard-hat 1.svg');
  ...
  /// File path: assets/icons/roadmap 1.svg
  SvgGenImage get roadmap1 => const SvgGenImage('assets/icons/roadmap 1.svg');

  /// File path: assets/icons/social-insurance 1.svg
  SvgGenImage get socialInsurance1 =>
      const SvgGenImage('assets/icons/social-insurance 1.svg');

  /// File path: assets/icons/sunbed-holiday-vacation.svg
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [header];
}
